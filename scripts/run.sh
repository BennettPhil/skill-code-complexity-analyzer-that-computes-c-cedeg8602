...
DEFAULT_TOPIC="A code complexity analyzer that computes cyclomatic complexity, cognitive complexity, and function length metrics for source files. Output a ranked list of the most complex functions."
DEFAULT_CONTEXT="Support JavaScript, TypeScript, and Python. Provide a threshold-based pass/fail for CI integration."
